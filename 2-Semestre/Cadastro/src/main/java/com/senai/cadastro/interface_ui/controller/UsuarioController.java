...
public class UsuarioController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UsuarioResponseDTO> searchUserById(@PathVariable UUID id) {
        return ResponseEntity.ok(usuarioService.findById(id));
    }

    @PostMapping
    public ResponseEntity<UsuarioResponseDTO> registerUser(@Valid @RequestBody UsuarioRequestDTO usuarioRequestDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UsuarioResponseDTO> updateUser(@PathVariable UUID id, @Valid @RequestBody UsuarioRequestDTO usuarioRequestDTO) {
